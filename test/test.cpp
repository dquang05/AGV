...
void lidarTask(void *parameter)
{
  ...
  while (1)
  {
    ...
    // {
    //   Serial.print("LIDAR points read per second: ");
...
void setup()
{
  ...
  delay(10);
  rlidar.speed_set(50, 10000); // Set LIDAR speed and frequency
  delay(10);
  rlidar.speed_set(50, 50000); // Set LIDAR speed and frequency
